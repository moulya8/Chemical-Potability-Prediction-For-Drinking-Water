...
ph =st.number_input("Enter PH Level",min_value=0,max_value=14,format="%i")
...
Conductivity=st.number_input("Enter the value of Conductivity",min_value=160,max_value=800,format="%.2f")
Trihalomethanes=st.number_input("Enter the value of Trihalomethanes",min_value=0,max_value=130,format="%.2f")
Turbidity=st.number_input("Enter the value of Turbidity",min_value=1,max_value=7,format="%.2f")
